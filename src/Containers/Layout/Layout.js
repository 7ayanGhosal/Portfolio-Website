...
import EduElement from "../../Components/Education/eduElement/eduElement";
...
class Layout extends Component {
  EduElements = [
    <EduElement
      id={0}
      name="CBSE - X"
      description1="10 CGPA"
      description2="Received Certificate of Merit from CBSE for obtaining 10/10 CGPA."
    />,
    <EduElement
      id={1}
      name="CBSE - XII"
      description1="Obtained 93.6 % Marks with an average of 96% in PCM"
    />,
    <EduElement
      id={2}
      name="WBJEE(2018)"
      description1="Ranked 381 out of 1.3 Lac candidates"
    />,
    <EduElement
      id={3}
      name="Bachelors Degree"
      description1="Jadvapur University, B.E Information Technology (2018-22)"
      description2="Average SGPA: 8.53 , as on 11-07-2020"
    />,
  ];

  Certifications = [
    <Certification
      certificate_path={W_D_B}
      id={0}
      platform={"Udemy"}
      ...
      duration={"6"}
      link={
        "https://www.udemy.com/certificate/UC-012d2764-030a-48e6-87ac-9d6400b2b3ec/"
      }
    />,
    <Certification
      certificate_path={I_Py}
      id={1}
      ...
      duration={"2"}
      link={
        "https://ninjasfiles.s3.amazonaws.com/certificate262625e65c0d0fcdea4b7ccd0389795c2c6edf.pdf"
      }
    />,
    <Certification
      certificate_path={DSA_Py}
      id={2}
      platform={"Udemy"}
      ...
      duration={"4"}
      link={
        "https://ninjasfiles.s3.amazonaws.com/certificate2626244790240f88d257f2e486ee8d6e834c40.pdf"
      }
    />,
  ];
    ...
    return (
      <Aux>
        ...
        <Education
          ...
          count={this.EduElements.length}
          frames={this.EduElements}
          back_color="dimgrey"
